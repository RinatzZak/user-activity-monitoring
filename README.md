...
|-----------------|-----------------------|----------|
| Sessing Window  | 5+ действий           | Блокировка пользователя на 2 минуты |
| Hopping Window  | 4+ действий           | Отправка предупреждения (без блокировки) |
| Tumbling Window | 7+ действий за сессию | Логирование подозрительной активности |
